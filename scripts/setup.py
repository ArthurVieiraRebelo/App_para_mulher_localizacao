...
Inicializa banco de dados, ambiente e estrutura.
"""
...
def gerar_icones():
    ...
    try:
        from scripts.gerar_icones import gerar_icones as gerar
        gerar('static')
...
╚════════════════════════════════════════════════════════╝
    ...
    print('\n💡 Próximos passos:')
    print('   1. Configure WhatsApp Business API (ver docs/WHATSAPP_SETUP.md)')
    ...
    print('   - docs/DEVELOPMENT.md: Guia desenvolvimento')
    print('   - docs/WHATSAPP_SETUP.md: Integração WhatsApp')
